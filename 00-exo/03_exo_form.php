...
<html lang="fr">
  ...
  <body>
      <div class="jumbotron container">
        <h1 class="display-4">Cours php 7 - Exo formulaire PHP</h1>
      </div>
    <main class="container">
        <div class="row">
            <div class="col-sm-12 col-md-6">
              <!-- Exo faire un formulaire avec le champs prénom, nom, email, adresse code postal et ville -->
              <!-- 2 puis récupérer dans une page 03_form_traitement.php les informations de $_POST -->
              <!-- 3 puis on fabriquera ensemble un fichier .txt pour stocker les informations du form -->
                <form action="03_form_traitement.php" method="POST" class="p-2 border border-success">
