...
echo "<table class=\"table table-success table-striped table-striped\">";
    echo "<thead>";
        echo "<tr>";
            echo "<th>reference</th>";
            echo "<th>categrorie</th>";
            echo "<th>titre</th>";
...
<html lang="fr">
  ...
  <div class="jumbotron container">
        <h1 class="display-4 text-center">Le site - Connexion</h1>
        <p class="lead"></p>
        <hr class="my-4">
    </div>
    ...
    <main class="container bg-white">
        <div class="row">
            <div class="col-sm-12">
                <h1 class="text-center border border-success border-5 m-2 px-2">Connectez-vous</h1>
